...
struct default_handler {
  ...
  modbus::response::read_coils handle(uint8_t, const modbus::request::read_coils& req, modbus::errc_t& modbus_error) const {
  ...
  modbus::response::read_discrete_inputs handle(uint8_t,
                                                ...
                                                modbus::errc_t& modbus_error) const {
